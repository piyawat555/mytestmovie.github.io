...
@section('content')
    <div class="tv-info border-b border-green-800">
        <div class="container mx auto px-4 py-16 flex flex-col md:flex-row">
           <img src="{{$tvshow['poster_path']}}" class="w-64 md:w-96">
            <div class="md:ml-24">
              <h2 class="text-4xl font-semibold">ชื่อเรื่อง : {{$tvshow['name']}}</h2>
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span>วันที่ฉาย {{$tvshow['first_air_date']}}</span>
                    <span class="mx-2">|</span>
                     <span>
                        ประเภทภาพยนต์ {{$tvshow['genres']}}
                    </span>
                </div>
                <p class="text-gray-300 mt-8">
                    เรื่องย่อ : {{$tvshow['overview']}}
                </p>
                ...
                <div class="mt-12">
                    <div class="flex mt-4">
                        @foreach ($tvshow['created_by'] as $crew)
                            <div class="mr-8">
                                <div>{{$crew['name']}}</div>
                            <div class="text-sm text-gray-400">ผู้สร้าง</div>
                            </div>
                        @endforeach
                    </div>
                </div>
                    ...
                    <div x-data="{ isOpen: false }">
                        ...
                        <div class="mt-12">
                            ...
                            >
                                ...
                                <span class="ml-2">ตัวอย่างซีรี่ย์</span>
                            </button>
                        </div>
