    ...
    <nav class="border-b border-green-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <a href="{{route('movies.index')}}" class="hove:text-gray-300">หน้าหลัก</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{route('tv.index')}}" class="hove:text-gray-300">ซีรีย์</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                <a href="{{route('actors.index')}}" class="hove:text-gray-300">นักแสดง</a>
                </li>
            </ul>
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="">
                        <img src="/img/avatar.jpg" alt="avatar"class="rounded-full w-10 h-10">
                    </a>
                </div>
            </div>
        </div>
