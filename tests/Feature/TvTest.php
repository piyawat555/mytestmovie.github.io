...
{
    /** @test */
    public function test_the_tv_index_page_shows_the_correct_info()
    {
        ...
        $response->assertSee('ซีรีย์ยอดนิยม');
        $response->assertSee('The Simpsons');
        $response->assertSee('Animation, Comedy');
        $response->assertSee('อันดับซีรีย์ยอดนิยม');
        $response->assertSee('Breaking Bad');
    }

    /** @test */
    public function test_the_tv_page_shows_the_correct_info()
    {
        $this->withoutExceptionHandling();
