...
class TvShowModel extends ViewModel
{
    ...
    public function tvshow(){
        return collect($this->tvshow)->merge([
                ...
                'image'=>collect($this->tvshow['images']['backdrops'])->take(9),
        ])->only([
          'created_by','poster_path', 'id', 'genre_ids', 'name', 'vote_average', 'overview', 'first_air_date', 'genres','crew','cast','image','videos',
         ]);
    }
}
